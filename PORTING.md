...
- [~] The requested Annex B subset follows completed `eval`/`with`: B.1.2 legacy RegExp grammar and B.2.2.1/.15/.16, B.2.3.1-.3, and B.2.4.1 are complete. Legacy literal/direct/indirect-eval paths retain exact UTF-16, including lone surrogates, and `RegExp.prototype.compile` rejects subclass and cross-realm receivers. At pinned Test262 `be13516fb6441b950ba8a3df97eb34062c186972`, the checked-in `annexB` policy passes 184/184 admitted modes; 1,191 baseline-excluded and two unsupported-host modes remain skipped. Only B.3 remains from the requested subset. The normative object-initializer `__proto__` setter emits verified `set_proto`; computed, shorthand, method, and accessor keys remain ordinary definitions.
