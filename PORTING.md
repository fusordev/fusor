...
- [ ] Class closure: class expressions, default constructors, `extends`,
  derived receiver initialization, `super()`/super properties, class-name
  writes, fields, private elements, computed keys, decorators, and static
  blocks. Do not relabel these as supported merely because Oxc parses them.
