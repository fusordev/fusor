...
const fn direct_eval_header(
    ...
    capabilities: Option<fusor_frontend::DirectEvalCapabilities>,
) -> UnverifiedFunctionHeader {
    let capabilities = match capabilities {
        Some(capabilities) => capabilities,
        None => fusor_frontend::DirectEvalCapabilities::new(),
    };
...
const fn executable_header(
    ...
    defined_argument_count: u32,
    variable_reference_count: u32,
    direct_eval_capabilities: Option<fusor_frontend::DirectEvalCapabilities>,
    has_top_level_await: bool,
) -> UnverifiedFunctionHeader {
