...
use fusor_frontend::{CompilationGoal, DirectEvalBindingKind, Span};
...
impl<'arena> CompilationContext<'_, 'arena, '_> {
    ...
    fn record_regexp_literal_candidate(
        ...
        fusor_regexp::CompiledRegExp::compile_utf16(
            &pattern_units,
            &flag_units,
...
mod tests {
    ...
    use fusor_bytecode::{Binary64Constant, CompilerConstantValue, CompilerString};
    use fusor_frontend::{
