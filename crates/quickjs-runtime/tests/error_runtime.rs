...
const REALM_ERROR_GRAPH_FUNCTIONS: u64 = 122;
const REALM_ERROR_GRAPH_PROPERTIES: u64 = 410;
const REALM_DYNAMIC_ATOMS: u32 = 83;
const REALM_DYNAMIC_ATOM_CODE_UNITS: u64 = 718;
const REALM_DYNAMIC_INTERNER_SLOTS: u32 = 83;
...
fn error_realm_graph_limit_failures_are_atomic_and_runtime_is_reusable() {
    for (limits, expected_resource, limit, observed) in [
        ...
        (
            RuntimeLimits::default().with_max_heap_functions(243),
            RuntimeResource::HeapFunctions,
            243,
            244,
        ),
        (
            RuntimeLimits::default().with_max_object_properties(819),
