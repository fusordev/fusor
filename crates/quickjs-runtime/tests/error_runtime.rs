...
const REALM_ERROR_GRAPH_FUNCTIONS: u64 = 161;
const REALM_ERROR_GRAPH_PROPERTIES: u64 = 533;
const REALM_DYNAMIC_ATOMS: u32 = 102;
const REALM_DYNAMIC_ATOM_CODE_UNITS: u64 = 914;
const REALM_DYNAMIC_INTERNER_SLOTS: u32 = 102;
...
fn error_realm_graph_limit_failures_are_atomic_and_runtime_is_reusable() {
    for (limits, expected_resource, limit, observed) in [
        ...
        (
            RuntimeLimits::default().with_max_heap_functions(321),
            RuntimeResource::HeapFunctions,
            321,
            322,
        ),
        (
            RuntimeLimits::default().with_max_object_properties(1065),
