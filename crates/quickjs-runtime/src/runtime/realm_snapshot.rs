...
mod tests {
    ...
    const REALM_NODES: usize = 675;
    const REALM_PROPERTIES: u64 = 2_061;
    const REALM_SNAPSHOT_FINGERPRINT: u64 = 15_887_755_049_157_056_881;
    ...
    fn realm_snapshots_normalize_local_identity_and_preserve_isolation() {
        ...
        assert_eq!(
            first_atoms,
            AtomUsage {
                live_atoms: PREDEFINED_ATOM_COUNT + 324,
                live_description_code_units: PREDEFINED_DESCRIPTION_CODE_UNITS + 2_770,
                interner_slots: PREDEFINED_INTERNER_SLOTS + 324,
            }
        );
