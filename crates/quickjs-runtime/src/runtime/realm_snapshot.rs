...
mod tests {
    ...
    const REALM_NODES: usize = 754;
    const REALM_PROPERTIES: u64 = 2_298;
    const REALM_SNAPSHOT_FINGERPRINT: u64 = 15_882_177_992_051_365_694;
    ...
    fn realm_snapshots_normalize_local_identity_and_preserve_isolation() {
        ...
        assert_eq!(
            first_atoms,
            AtomUsage {
                live_atoms: PREDEFINED_ATOM_COUNT + 334,
                live_description_code_units: PREDEFINED_DESCRIPTION_CODE_UNITS + 2_883,
                interner_slots: PREDEFINED_INTERNER_SLOTS + 334,
            }
        );
