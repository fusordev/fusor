...
fn exception_code(exception: &JsException) -> &'static str {
    match exception.kind() {
        Some(ExceptionKind::InternalError) => "quickjs::runtime::exception::internal_error",
        Some(ExceptionKind::RangeError) => "quickjs::runtime::exception::range_error",
        Some(ExceptionKind::ReferenceError) => "quickjs::runtime::exception::reference_error",
        Some(ExceptionKind::SyntaxError) => "quickjs::runtime::exception::syntax_error",
        Some(ExceptionKind::TypeError) => "quickjs::runtime::exception::type_error",
        Some(ExceptionKind::UriError) => "quickjs::runtime::exception::uri_error",
        None => "quickjs::runtime::exception::thrown_value",
    }
}
...
impl RuntimeError {
    ...
    pub fn to_diagnostic(&self) -> Result<Diagnostic, RuntimeDiagnosticError> {
        let code = match self {
            Self::Atom(_) => "quickjs::runtime::atom",
            Self::LimitExceeded { .. } => "quickjs::runtime::limit_exceeded",
            Self::AllocationFailed { .. } => "quickjs::runtime::allocation_failed",
        };
...
impl InstallError {
    ...
    pub fn to_diagnostic(&self) -> Result<Diagnostic, RuntimeDiagnosticError> {
        let code = match self {
            Self::UnsupportedOpcode { .. } => "quickjs::runtime::install::unsupported_opcode",
            Self::LimitExceeded { .. } => "quickjs::runtime::install::limit_exceeded",
            Self::AllocationFailed { .. } => "quickjs::runtime::install::allocation_failed",
            Self::String(_) => "quickjs::runtime::install::string",
            Self::BigInt(_) => "quickjs::runtime::install::bigint",
            Self::Atom(_) => "quickjs::runtime::install::atom",
            Self::GlobalDeclarationRejected { .. } => {
                "quickjs::runtime::install::global_declaration_rejected"
            }
            Self::AuthorityInvariant { .. } => "quickjs::runtime::install::authority_invariant",
        };
        diagnostic(code, DiagnosticSeverity::Error, self.to_string())
    }
}
...
impl ExecutionError {
    ...
    pub fn to_diagnostic_report(
        ...
        let code = match self {
            ...
            Self::Handle(_) => "quickjs::runtime::execution::handle",
            Self::Atom(_) => "quickjs::runtime::execution::atom",
            Self::DynamicFunctionCompilation(_) => {
                "quickjs::runtime::execution::dynamic_function_compilation"
            }
            Self::DynamicFunctionInstallation(_) => {
                "quickjs::runtime::execution::dynamic_function_installation"
            }
            Self::Interrupted { .. } => "quickjs::runtime::execution::interrupted",
            Self::InstructionLimitExceeded { .. } => {
                "quickjs::runtime::execution::instruction_limit_exceeded"
            }
            Self::LimitExceeded { .. } => "quickjs::runtime::execution::limit_exceeded",
            Self::AllocationFailed { .. } => "quickjs::runtime::execution::allocation_failed",
            Self::String(_) => "quickjs::runtime::execution::string",
            Self::EngineFault(_) => "quickjs::runtime::execution::engine_fault",
        };
...
mod tests {
    ...
    use quickjs_diagnostics::{SourceMap, SourceRegistry, render_pretty_report};
    ...
    fn exception_reports_resolve_origins_and_render_callers_as_related_sources() {
        ...
        assert_eq!(
            ...
            "quickjs::runtime::exception::type_error"
        );
        assert_eq!(
