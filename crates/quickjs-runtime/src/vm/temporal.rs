...
use temporal_rs::{
    ...
    PlainYearMonth, Sign, TimeZone, UtcOffset, ZonedDateTime,
    ...
    parsers::Precision,
    partial::{PartialDate, PartialDateTime, PartialTime, PartialYearMonth, PartialZonedDateTime},
...
pub(super) struct TemporalPlainDateTimeConstructorContinuation {
    arguments: Vec<StoredValue>,
    converted: Vec<JsNumber>,
    new_target: FunctionId,
}
...
pub(super) struct TemporalPlainMonthDayConstructorContinuation {
    arguments: Vec<StoredValue>,
    converted: Vec<JsNumber>,
...
const TEMPORAL_PLAIN_MONTH_DAY_BAG_FIELDS: [&str; 5] =
    ["calendar", "day", "month", "monthCode", "year"];
const TEMPORAL_PLAIN_YEAR_MONTH_BAG_FIELDS: [&str; 4] = ["calendar", "month", "monthCode", "year"];
const TEMPORAL_PLAIN_YEAR_MONTH_WITH_FIELDS: [&str; 5] =
    ["calendar", "timeZone", "month", "monthCode", "year"];
...
const TEMPORAL_PLAIN_TIME_BAG_FIELDS: [&str; 6] = [
    "hour",
    "microsecond",
    "millisecond",
    "minute",
...
const TEMPORAL_PLAIN_MONTH_DAY_WITH_FIELDS: [&str; 6] =
    ["calendar", "timeZone", "day", "month", "monthCode", "year"];
...
pub(super) struct TemporalPlainDateBagContinuation {
    base: StoredValue,
    calendar: Option<Calendar>,
    day: Option<JsNumber>,
...
struct TemporalPlainYearMonthFields {
    calendar: Option<Calendar>,
    month: Option<JsNumber>,
    month_code: Option<MonthCode>,
    year: Option<JsNumber>,
...
pub(super) struct TemporalPlainYearMonthBagContinuation {
    base: StoredValue,
    calendar: Option<Calendar>,
    month: Option<JsNumber>,
    month_code: Option<MonthCode>,
...
struct TemporalPlainYearMonthWithFields {
    month: Option<i64>,
    month_code: Option<MonthCode>,
    year: Option<i64>,
}
...
pub(super) struct TemporalPlainYearMonthWithContinuation {
    receiver: PlainYearMonth,
    base: StoredValue,
...
pub(super) struct TemporalPlainYearMonthDifferenceContinuation {
    receiver: PlainYearMonth,
...
struct TemporalPlainMonthDayFields {
    calendar: Option<Calendar>,
    day: Option<JsNumber>,
    month: Option<JsNumber>,
    month_code: Option<MonthCode>,
...
pub(super) struct TemporalPlainMonthDayBagContinuation {
    base: StoredValue,
    calendar: Option<Calendar>,
    day: Option<JsNumber>,
    month: Option<JsNumber>,
...
pub(super) struct TemporalPlainDateTimeBagContinuation {
    ...
    month: Option<JsNumber>,
    month_code: Option<TemporalPlainDateTimeMonthCode>,
...
enum TemporalPlainDateTimeMonthCode {
    Parsed(MonthCode),
    Raw(JsString),
}
...
pub(super) struct TemporalZonedDateTimeBagContinuation {
    base: StoredValue,
    calendar: Option<Calendar>,
    day: Option<JsNumber>,
    hour: Option<JsNumber>,
...
pub(super) struct TemporalZonedDateTimeOptionsContinuation {
...
pub(super) struct TemporalPlainDateWithContinuation {
    receiver: PlainDate,
    base: StoredValue,
...
struct TemporalPlainDateTimeWithFields {
    year: Option<i64>,
    month: Option<i64>,
...
pub(super) struct TemporalPlainMonthDayToStringContinuation {
...
pub(super) struct TemporalPlainYearMonthToStringContinuation {
...
pub(super) struct TemporalPlainMonthDayToPlainDateContinuation {
    month_day: PlainMonthDay,
    fields: StoredValue,
...
pub(super) struct TemporalPlainYearMonthToPlainDateContinuation {
    year_month: PlainYearMonth,
    fields: StoredValue,
...
struct TemporalPlainMonthDayWithFields {
    day: Option<i64>,
    month: Option<i64>,
    month_code: Option<MonthCode>,
    year: Option<i64>,
...
pub(super) struct TemporalPlainMonthDayWithContinuation {
    receiver: PlainMonthDay,
    base: StoredValue,
    fields: TemporalPlainMonthDayWithFields,
    next: usize,
...
pub(super) fn begin_temporal_plain_month_day_constructor(
    runtime: &mut Runtime,
    realm: RealmId,
    inputs: CallInputs,
    return_to: Option<CallReturn>,
...
pub(super) fn advance_temporal_plain_month_day_constructor(
    runtime: &mut Runtime,
...
pub(super) fn finish_temporal_plain_month_day_constructor_wrapper(
    runtime: &mut Runtime,
    new_target: FunctionId,
    month_day: PlainMonthDay,
    requested: &StoredValue,
...
pub(super) fn begin_temporal_plain_year_month_constructor(
    runtime: &mut Runtime,
    realm: RealmId,
    inputs: CallInputs,
    return_to: Option<CallReturn>,
...
pub(super) fn advance_temporal_plain_year_month_constructor(
    runtime: &mut Runtime,
...
pub(super) fn finish_temporal_plain_year_month_constructor_wrapper(
    runtime: &mut Runtime,
    new_target: FunctionId,
    year_month: PlainYearMonth,
    requested: &StoredValue,
...
pub(super) fn advance_temporal_zoned_date_time_from_options(
    runtime: &mut Runtime,
    mut state: TemporalZonedDateTimeOptionsContinuation,
...
pub(super) fn advance_temporal_zoned_date_time_property_bag(
    runtime: &mut Runtime,
...
fn temporal_zoned_date_time_time_zone_from_value(
    runtime: &Runtime,
    value: StoredValue,
    realm: RealmId,
    origin: &JsStackFrame,
...
pub(super) fn begin_temporal_plain_date_time_constructor(
    runtime: &mut Runtime,
    realm: RealmId,
    inputs: CallInputs,
    return_to: Option<CallReturn>,
...
pub(super) fn advance_temporal_plain_date_time_constructor(
    runtime: &mut Runtime,
...
pub(super) fn finish_temporal_plain_date_time_constructor_wrapper(
    runtime: &mut Runtime,
    new_target: FunctionId,
    date_time: PlainDateTime,
    requested: &StoredValue,
...
pub(super) fn advance_temporal_plain_time_options(
    runtime: &mut Runtime,
...
fn temporal_plain_time_from_bag(
    state: &TemporalPlainDateTimeBagContinuation,
...
fn temporal_plain_date_time_with_fields(
    fields: &TemporalPlainDateTimeWithFields,
    realm: RealmId,
    origin: &JsStackFrame,
...
pub(super) fn advance_temporal_plain_date_from_options(
    runtime: &mut Runtime,
...
pub(super) fn advance_temporal_plain_date_property_bag(
    runtime: &mut Runtime,
...
fn temporal_plain_date_required_field(
    value: Option<JsNumber>,
    field: &str,
    realm: RealmId,
    origin: &JsStackFrame,
...
fn finish_temporal_plain_date_to_plain_date_time(
    runtime: &mut Runtime,
    date: &PlainDate,
    time: Option<PlainTime>,
    realm: RealmId,
...
pub(super) fn advance_temporal_plain_date_with(
    runtime: &mut Runtime,
...
pub(super) fn begin_temporal_plain_month_day_static(
    runtime: &mut Runtime,
...
pub(super) fn dispatch_temporal_plain_month_day_prototype(
    runtime: &mut Runtime,
...
pub(super) fn begin_temporal_plain_year_month_static(
    runtime: &mut Runtime,
...
pub(super) fn dispatch_temporal_plain_year_month_prototype(
    runtime: &mut Runtime,
...
pub(super) fn advance_temporal_plain_year_month_property_bag(
    runtime: &mut Runtime,
        ...
        match state.stage {
            ...
            TemporalPlainYearMonthBagStage::AwaitField => {
                ...
                if field == "calendar" {
                    ...
                    state.calendar = Some(match Calendar::from_str(&value.to_utf8_lossy()?) {
                        Ok(calendar) => calendar,
                        Err(error) => {
                            return Err(NativeFailure::Abrupt(temporal_exception_from_error(
                                state.realm,
                ...
                let hint = match field {
                    "monthCode" => OperatorPrimitiveHint::String,
                    "month" | "year" => OperatorPrimitiveHint::Number,
                    _ => {
                        return Err(EngineFault::RuntimeInvariant {
...
fn temporal_plain_year_month_from_fields(
    ...
    let year = temporal_plain_date_required_field(fields.year, "year", realm, origin)?;
    let Ok(year) = i32::try_from(year) else {
        return Err(NativeFailure::Abrupt(temporal_pending_exception(
            realm,
            origin,
            ExceptionKind::RangeError,
            "Temporal.PlainYearMonth year is outside the supported range",
        )?));
    };
    let month = fields
        .month
        ...
        .transpose()?
        .map(|month| temporal_plain_year_month_month(month, overflow, realm, origin))
        .transpose()?;
    ...
    let partial = PartialYearMonth {
        calendar_fields,
        calendar: fields.calendar.clone().unwrap_or_default(),
    };
...
fn temporal_plain_year_month_month(
    ...
    let month = match overflow {
        Overflow::Constrain => month.min(12),
...
pub(super) fn advance_temporal_plain_year_month_with(
    runtime: &mut Runtime,
...
fn temporal_plain_year_month_with_fields(
    fields: &TemporalPlainYearMonthWithFields,
    overflow: Overflow,
    realm: RealmId,
    origin: &JsStackFrame,
...
pub(super) fn advance_temporal_plain_year_month_difference_options(
    runtime: &mut Runtime,
    state: TemporalPlainYearMonthDifferenceContinuation,
    value: StoredValue,
    return_to: Option<CallReturn>,
...
pub(super) fn finish_temporal_plain_year_month_difference_largest_unit(
    runtime: &mut Runtime,
    mut state: TemporalPlainYearMonthDifferenceContinuation,
    value: StoredValue,
    return_to: Option<CallReturn>,
...
pub(super) fn finish_temporal_plain_year_month_difference_rounding_increment(
    runtime: &mut Runtime,
    mut state: TemporalPlainYearMonthDifferenceContinuation,
    value: StoredValue,
    return_to: Option<CallReturn>,
...
pub(super) fn finish_temporal_plain_year_month_difference_rounding_mode(
    runtime: &mut Runtime,
    mut state: TemporalPlainYearMonthDifferenceContinuation,
    value: StoredValue,
    return_to: Option<CallReturn>,
...
pub(super) fn finish_temporal_plain_year_month_difference_smallest_unit(
    runtime: &mut Runtime,
    state: &TemporalPlainYearMonthDifferenceContinuation,
    value: StoredValue,
) -> Result<NativeDispatch, NativeFailure> {
...
pub(super) fn advance_temporal_plain_year_month_to_string(
    runtime: &mut Runtime,
    state: TemporalPlainYearMonthToStringContinuation,
    value: StoredValue,
    return_to: Option<CallReturn>,
...
pub(super) fn finish_temporal_plain_year_month_to_string_calendar_name(
    state: &TemporalPlainYearMonthToStringContinuation,
    value: StoredValue,
) -> Result<NativeDispatch, NativeFailure> {
    let source = operator_primitive_to_string(value, state.realm, &state.origin)?;
...
pub(super) fn advance_temporal_plain_month_day_property_bag(
    runtime: &mut Runtime,
...
fn temporal_plain_month_day_from_fields(
    ...
    let year = fields
        .year
        .map(|value| temporal_plain_date_integer(value, "year", realm, origin))
        .transpose()?
        .unwrap_or(1972);
    let Ok(year) = i32::try_from(year) else {
        return Err(NativeFailure::Abrupt(temporal_pending_exception(
            ...
            origin,
            ExceptionKind::RangeError,
            "Temporal.PlainMonthDay property bag fields are outside the supported range",
        )?));
    };
    let day = temporal_plain_month_day_field_u8(day, "day", 31, overflow, realm, origin)?;
    let month = match month {
        Some(month) => Some(temporal_plain_month_day_field_u8(
            month, "month", 12, overflow, realm, origin,
        )?),
        None => None,
    };
    let partial = PartialDate::new()
        .with_calendar(fields.calendar.clone().unwrap_or_default())
        .with_year(Some(year))
        .with_month(month)
...
fn temporal_plain_month_day_with_fields(
    fields: &TemporalPlainMonthDayWithFields,
    overflow: Overflow,
    realm: RealmId,
    origin: &JsStackFrame,
    ...
    let month = fields
        .month
        .map(|value| temporal_plain_month_day_field_u8(value, "month", 12, overflow, realm, origin))
        .transpose()?;
    let day = fields
        .day
        .map(|value| temporal_plain_month_day_field_u8(value, "day", 31, overflow, realm, origin))
        .transpose()?;
...
pub(super) fn advance_temporal_plain_month_day_with(
    runtime: &mut Runtime,
...
fn allocate_temporal_plain_month_day_result(
    runtime: &mut Runtime,
    realm: RealmId,
    month_day: PlainMonthDay,
) -> Result<NativeDispatch, NativeFailure> {
...
fn allocate_temporal_plain_year_month_result(
    runtime: &mut Runtime,
    realm: RealmId,
    year_month: PlainYearMonth,
) -> Result<NativeDispatch, NativeFailure> {
...
fn require_temporal_plain_month_day(
    runtime: &Runtime,
    receiver: &StoredValue,
    realm: RealmId,
    origin: &JsStackFrame,
...
fn require_temporal_plain_year_month(
    runtime: &Runtime,
    receiver: &StoredValue,
    realm: RealmId,
    origin: &JsStackFrame,
...
pub(super) fn advance_temporal_plain_month_day_to_plain_date(
    runtime: &mut Runtime,
...
pub(super) fn advance_temporal_plain_year_month_to_plain_date(
    runtime: &mut Runtime,
...
pub(super) fn advance_temporal_plain_month_day_to_string(
    runtime: &mut Runtime,
    state: TemporalPlainMonthDayToStringContinuation,
    value: StoredValue,
    return_to: Option<CallReturn>,
...
pub(super) fn finish_temporal_plain_month_day_to_string_calendar_name(
    state: &TemporalPlainMonthDayToStringContinuation,
    value: StoredValue,
) -> Result<NativeDispatch, NativeFailure> {
    let source = operator_primitive_to_string(value, state.realm, &state.origin)?;
...
pub(super) fn dispatch_temporal_plain_date_time_prototype(
    runtime: &mut Runtime,
...
pub(super) fn advance_temporal_plain_date_time_round_options(
    runtime: &mut Runtime,
    state: TemporalPlainDateTimeRoundContinuation,
    value: StoredValue,
    return_to: Option<CallReturn>,
...
pub(super) fn finish_temporal_plain_date_time_round_rounding_increment(
    runtime: &mut Runtime,
    mut state: TemporalPlainDateTimeRoundContinuation,
    value: StoredValue,
    return_to: Option<CallReturn>,
...
pub(super) fn finish_temporal_plain_date_time_round_rounding_mode(
    runtime: &mut Runtime,
    mut state: TemporalPlainDateTimeRoundContinuation,
    value: StoredValue,
    return_to: Option<CallReturn>,
...
pub(super) fn finish_temporal_plain_date_time_round_smallest_unit(
    runtime: &mut Runtime,
    state: &TemporalPlainDateTimeRoundContinuation,
    value: StoredValue,
) -> Result<NativeDispatch, NativeFailure> {
...
pub(super) struct TemporalPlainDateTimeRoundContinuation {
    date_time: PlainDateTime,
    options: StoredValue,
    rounding_increment: RoundingIncrement,
    rounding_mode: RoundingMode,
...
pub(super) struct TemporalPlainDateTimeDifferenceContinuation {
    receiver: PlainDateTime,
    other: PlainDateTime,
    options: StoredValue,
    largest_unit: Option<Unit>,
...
pub(super) struct TemporalPlainTimeDifferenceContinuation {
    receiver: PlainTime,
    other: PlainTime,
    options: StoredValue,
    largest_unit: Option<Unit>,
...
/// Every Get and primitive conversion may invoke JavaScript.
pub(super) struct TemporalPlainTimeToStringContinuation {
    time: PlainTime,
    options: StoredValue,
    precision: Precision,
    rounding_mode: RoundingMode,
...
fn normalize_temporal_duration_fields(duration: Duration) -> Result<Duration, NativeFailure> {
    #[allow(
        clippy::cast_precision_loss,
        clippy::cast_possible_truncation,
...
pub(super) fn advance_temporal_plain_date_time_difference_options(
    runtime: &mut Runtime,
    state: TemporalPlainDateTimeDifferenceContinuation,
    value: StoredValue,
    return_to: Option<CallReturn>,
...
pub(super) fn finish_temporal_plain_date_time_difference_largest_unit(
    runtime: &mut Runtime,
    mut state: TemporalPlainDateTimeDifferenceContinuation,
    value: StoredValue,
    return_to: Option<CallReturn>,
...
pub(super) fn finish_temporal_plain_date_time_difference_rounding_increment(
    runtime: &mut Runtime,
    mut state: TemporalPlainDateTimeDifferenceContinuation,
    value: StoredValue,
    return_to: Option<CallReturn>,
...
pub(super) fn finish_temporal_plain_date_time_difference_rounding_mode(
    runtime: &mut Runtime,
    mut state: TemporalPlainDateTimeDifferenceContinuation,
    value: StoredValue,
    return_to: Option<CallReturn>,
...
pub(super) fn finish_temporal_plain_date_time_difference_smallest_unit(
    runtime: &mut Runtime,
    state: &TemporalPlainDateTimeDifferenceContinuation,
    value: StoredValue,
) -> Result<NativeDispatch, NativeFailure> {
...
pub(super) fn advance_temporal_plain_time_difference_options(
    runtime: &mut Runtime,
    state: TemporalPlainTimeDifferenceContinuation,
    value: StoredValue,
    return_to: Option<CallReturn>,
...
pub(super) fn finish_temporal_plain_time_difference_largest_unit(
    runtime: &mut Runtime,
    mut state: TemporalPlainTimeDifferenceContinuation,
    value: StoredValue,
    return_to: Option<CallReturn>,
...
pub(super) fn finish_temporal_plain_time_difference_rounding_increment(
    runtime: &mut Runtime,
    mut state: TemporalPlainTimeDifferenceContinuation,
    value: StoredValue,
    return_to: Option<CallReturn>,
...
pub(super) fn finish_temporal_plain_time_difference_rounding_mode(
    runtime: &mut Runtime,
    mut state: TemporalPlainTimeDifferenceContinuation,
    value: StoredValue,
    return_to: Option<CallReturn>,
...
pub(super) fn finish_temporal_plain_time_difference_smallest_unit(
    runtime: &mut Runtime,
    state: &TemporalPlainTimeDifferenceContinuation,
    value: StoredValue,
) -> Result<NativeDispatch, NativeFailure> {
...
pub(super) fn advance_temporal_plain_time_to_string_options(
    runtime: &mut Runtime,
    mut state: TemporalPlainTimeToStringContinuation,
    value: StoredValue,
    return_to: Option<CallReturn>,
...
pub(super) fn finish_temporal_plain_time_to_string_fractional_second_digits(
    runtime: &mut Runtime,
    mut state: TemporalPlainTimeToStringContinuation,
    value: StoredValue,
    return_to: Option<CallReturn>,
...
pub(super) fn finish_temporal_plain_time_to_string_rounding_mode(
    runtime: &mut Runtime,
    mut state: TemporalPlainTimeToStringContinuation,
    value: StoredValue,
    return_to: Option<CallReturn>,
...
pub(super) fn finish_temporal_plain_time_to_string_smallest_unit(
    state: &TemporalPlainTimeToStringContinuation,
    value: StoredValue,
) -> Result<NativeDispatch, NativeFailure> {
    let source = operator_primitive_to_string(value, state.realm, &state.origin)?;
...
pub(super) fn temporal_pending_exception(
    realm: RealmId,
    origin: &JsStackFrame,
    kind: ExceptionKind,
    message: &str,
