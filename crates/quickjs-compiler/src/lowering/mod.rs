...
use oxc_ast::{
    ...
    ast::{
        ...
        CallExpression, CatchClause, ChainElement, ChainExpression, Class, ClassElement,
        ...
        ForStatementLeft, FormalParameter, Function, FunctionType, IdentifierReference,
        IfStatement, LabelIdentifier, LabeledStatement, LogicalExpression, MethodDefinition,
