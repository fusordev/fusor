...
use oxc_ast::{
    ...
    ast::{
        ...
        BindingRestElement, CallExpression, CatchClause, ChainElement, ChainExpression,
        ...
        LabelIdentifier, LabeledStatement, LogicalExpression, NewExpression,
        ObjectAssignmentTarget, ObjectExpression, ObjectPattern, ObjectProperty,
