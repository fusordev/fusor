...
fn binary64_and_function_templates_share_one_typed_constant_pool() {
    ...
    assert_eq!(
        ...
        [
            quickjs_bytecode::CompilerConstant::Value(CompilerConstantValue::Number(
                Binary64Constant::from_f64(1.5),
            )),
            quickjs_bytecode::CompilerConstant::Function(
                quickjs_bytecode::FunctionTemplateId::new(1),
            ),
            quickjs_bytecode::CompilerConstant::Value(CompilerConstantValue::Number(
