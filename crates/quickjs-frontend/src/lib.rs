...
pub use frontend::{
    ...
    DirectEvalBindingKind, DirectEvalBindingLocation, DirectEvalCapabilities, DirectEvalContext,
    DirectEvalPrivateName, DirectEvalPrivateNameKind, DirectEvalScopeFrame, DirectEvalScopeKind,
    DirectEvalScopeSnapshot, DynamicFunctionByteRange, DynamicFunctionError,
    DynamicFunctionFragmentMap, DynamicFunctionFragmentRole, DynamicFunctionKind,
    DynamicFunctionMapError, DynamicFunctionMappedSegment, DynamicFunctionMappedSource,
    DynamicFunctionPreparationResource, DynamicFunctionSource, DynamicFunctionSpanBias,
    DynamicFunctionSyntheticKind, FrontendDiagnostic, FrontendDiagnosticCode, FrontendError,
    FrontendLimitError, FrontendLimits, FrontendOptions, FrontendSourceError, GlobalScriptGoal,
    IndirectEvalGoal, IsolatedFrontendContext, ModuleRecord, ParseMode, ParsedUnit,
