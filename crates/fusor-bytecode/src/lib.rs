...
//! compiler-bytecode verification for the Experimental JavaScript Engine.
//!
...
//! runtime function or closure. The current `fusor-runtime` interpreter can
...
pub use verified_bytecode::{
    ...
    BytecodeCodecError, BytecodeGraphResource, BytecodeGraphUsage, BytecodeGraphVerificationLimits,
    BytecodeVerificationError, BytecodeVerificationErrorKind, ClosureVariableDefinition,
    CompilerBindingKind, CompilerBindingPolicy, CompilerClosureBinding, CompilerExecutableKind,
    CompilerInitializationPolicy, CompilerSource, CompilerWritePolicy, EXECUTION_REQUIREMENT_COUNT,
    ExecutionRequirement, MAX_GOSUB_SITES_PER_FUNCTION, MetadataAtomField, ModuleBindingDescriptor,
    ModuleBindingOrigin, ModuleDeclarationRecord, ModuleImportName, ModuleRequestDescriptor,
    ...
    VerifiedBytecodeFunction, VerifiedCompilerSource, VerifiedFunctionMetadata, decode_atom_pool,
    ...
    read_sections, verify_compiler_bytecode_graph,
};
pub use verifier::{
