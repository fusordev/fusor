...
pub use verified_bytecode::{
    ...
    MetadataAtomField, ModuleBindingDescriptor, ModuleBindingOrigin, ModuleDeclarationRecord,
    ...
    encode_atom_pool, encode_closure_sources, encode_constant_pool, encode_graph,
