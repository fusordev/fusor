...
//! project-owned `fusor-regexp` layer then applies the specification's
...
impl FrontendDiagnosticCode {
    ...
    pub const fn as_str(self) -> &'static str {
        match self {
            Self::SourceBytesExceeded => "fusor::frontend::limit::source_bytes",
            Self::DynamicFunctionFragmentsExceeded => {
                "fusor::frontend::limit::dynamic_function_fragments"
            }
            Self::DynamicFunctionOriginBytesExceeded => {
                "fusor::frontend::limit::dynamic_function_origin_bytes"
            }
            Self::DynamicFunctionPreparationFailed => {
                "fusor::frontend::limit::dynamic_function_preparation"
            }
            Self::UnsupportedCompilationGoal => "fusor::frontend::unsupported_compilation_goal",
            Self::IsolatedContextUnavailable => "fusor::frontend::isolated_context_unavailable",
            Self::AsyncScriptModuleDeclaration => {
                "fusor::frontend::async_script::module_declaration"
            }
            Self::AsyncScriptAwaitIdentifier => "fusor::frontend::async_script::await_identifier",
            Self::AsyncScriptImportMeta => "fusor::frontend::async_script::import_meta",
            Self::OxcParser => "fusor::frontend::oxc::parser",
            Self::OxcSemantic => "fusor::frontend::oxc::semantic",
            Self::DirectEvalContainsArguments => {
                "fusor::frontend::semantic::direct_eval_contains_arguments"
            }
            Self::InvalidRegExpLiteral => "fusor::frontend::regexp::invalid_literal",
            Self::InvalidChainedContinueTarget => {
                "fusor::frontend::semantic::invalid_chained_continue_target"
            }
            Self::ModuleSyntaxLowering => "fusor::frontend::lowering::module_syntax",
            Self::UnsupportedUsingDeclaration => "fusor::frontend::profile::using_declaration",
            Self::UnsupportedAwaitUsingDeclaration => {
                "fusor::frontend::profile::await_using_declaration"
            }
            Self::UnsupportedImportSource => "fusor::frontend::profile::import_source",
            ...
            Self::UnsupportedStringNamedReExport => {
                "fusor::frontend::profile::string_named_reexport"
            }
            Self::UnsupportedStringNamespaceExport => {
                "fusor::frontend::profile::string_namespace_export"
            }
            Self::TooManyCallArguments => "fusor::frontend::profile::too_many_call_arguments",
        }
    }
...
impl FrontendError {
    ...
    fn invalid_regexp_literal(span: Span, source: &fusor_regexp::CompileError) -> Self {
        Self {
            stage: DiagnosticStage::Semantic,
            diagnostics: vec![FrontendDiagnostic {
    ...
    R: Send,
{
    std::thread::scope(|scope| {
        let worker = std::thread::Builder::new()
            .name("fusor-dynamic-frontend".to_owned())
