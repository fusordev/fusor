...
fn intl_locale_info<T>(
    locale: &JsString,
    operation: impl FnOnce(&str) -> Result<T, fusor_intl::InvalidLocale>,
...
struct SourcedNumberFormatPart {
    part: fusor_intl::NumberFormatPart,
    source: &'static str,
}
...
fn intl_number_format_parts_array(
    runtime: &mut Runtime,
    realm: RealmId,
    parts: Vec<fusor_intl::NumberFormatPart>,
...
fn intl_number_format_part_entries_array(
    runtime: &mut Runtime,
    realm: RealmId,
    parts: Vec<(fusor_intl::NumberFormatPart, Option<&'static str>)>,
) -> Result<NativeDispatch, NativeFailure> {
...
fn intl_relative_time_format_parts_array(
    runtime: &mut Runtime,
    realm: RealmId,
    parts: Vec<fusor_intl::RelativeTimeFormatPart>,
) -> Result<NativeDispatch, NativeFailure> {
    let mut values = Vec::new();
    values
        .try_reserve_exact(parts.len())
...
fn intl_list_format_parts_array(
    runtime: &mut Runtime,
    realm: RealmId,
    parts: Vec<fusor_intl::ListFormatPart>,
) -> Result<NativeDispatch, NativeFailure> {
    let mut values = Vec::new();
    values
        .try_reserve_exact(parts.len())
...
fn intl_duration_format_parts_array(
    runtime: &mut Runtime,
    realm: RealmId,
    parts: Vec<fusor_intl::DurationFormatPart>,
) -> Result<NativeDispatch, NativeFailure> {
    let mut values = Vec::new();
    values
        .try_reserve_exact(parts.len())
...
struct SourcedDateTimeFormatPart {
    part: fusor_intl::DateTimeFormatPart,
    source: &'static str,
}
...
fn common_date_time_part_prefix(
    first: &[fusor_intl::DateTimeFormatPart],
    second: &[fusor_intl::DateTimeFormatPart],
) -> usize {
    first
        .iter()
        .zip(second)
...
fn intl_date_time_format_parts_array(
    runtime: &mut Runtime,
    realm: RealmId,
    parts: Vec<fusor_intl::DateTimeFormatPart>,
    source: Option<&'static str>,
) -> Result<NativeDispatch, NativeFailure> {
...
fn intl_date_time_format_part_entries_array(
    runtime: &mut Runtime,
    realm: RealmId,
    parts: Vec<(fusor_intl::DateTimeFormatPart, Option<&'static str>)>,
) -> Result<NativeDispatch, NativeFailure> {
    let mut values = Vec::new();
    values
        .try_reserve_exact(parts.len())
