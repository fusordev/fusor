...
use fusor_bytecode::{FinalOpcode, FunctionTemplateId, VerificationLimits};
...
fn compile_dynamic(parameters: &[&str], body: &str) -> Arc<fusor_bytecode::VerifiedBytecode> {
...
/// `crates/fusor-runtime/tests/vm_bigint.rs` pins the observable behavior.
#[test]
