...
use fusor_bytecode::FinalOpcode;
...
fn opcodes(authority: &fusor_bytecode::VerifiedBytecode, function: u32) -> Vec<FinalOpcode> {
    authority
        .function(fusor_bytecode::FunctionTemplateId::new(function))
        .expect("function")
        .function()
        .control_flow()
        .instructions()
