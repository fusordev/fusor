...
use fusor_bytecode::FunctionTemplateId;
...
fn reserved_frame_values(
    authority: &fusor_bytecode::VerifiedBytecode,
...
fn function_prototype_call_can_target_itself_with_bounded_native_continuations() {
    ...
    assert!(matches!(
        ...
        ExecutionError::LimitExceeded {
            resource: fusor_runtime::RuntimeResource::Frames,
            limit: 3,
            observed: 4,
        }
    ));
...
fn function_prototype_call_continuation_retains_no_frame_values() {
    ...
    assert!(matches!(
        ...
        ExecutionError::LimitExceeded {
            resource: fusor_runtime::RuntimeResource::FrameValues,
            limit,
            observed,
